...
public class GameController implements ActionListener, KeyListener {
    ...
    public GameController(GameView view, JFrame frame, User player1, User player2) {
        this.view = view;
        this.frame = frame;
        ...
        this.physicsEngine = new PhysicsEngine(model, initialSpeed, maxDeformationFrames);
    ...
    private void updatePaddlePositions() {
        ...
        int paddleSpeed = 8; // Speed at which paddles move
